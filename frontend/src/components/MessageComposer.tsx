      ...
      <div className="max-w-4xl mx-auto" style={{ maxWidth: "1000px" }}>
              ...
              <div className="flex-1 overflow-y-auto p-4">
                {userMediaFiles.length === 0 ? (
                  <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm">
                      Upload files to your Personal Media Bucket from the right
                      sidebar
                    </p>
                  </div>
                ) : (
        ...
        <div className="mt-2 text-xs text-gray-500 dark:text-gray-400 text-center">
          {disabled ? (
            ...
            <>
              Press{" "}
              <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded text-xs">
                Enter
              </kbd>{" "}
              to send,
              <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded text-xs ml-1">
                Shift + Enter
              </kbd>{" "}
              for new line • Drag & drop files to attach
            </>
          )}
        </div>
      </div>
