...
import { FiChevronDown, FiChevronRight, FiImage, FiLink, FiHash, FiSend, FiX } from "react-icons/fi";
 ...
 */
const PostComposer: React.FC<PostComposerProps> = ({ user, onPostCreated }) => {
  // Accordion state
